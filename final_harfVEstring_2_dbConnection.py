...
class String_Databse():
    def __init__(self,string):
        ...
        self.baglanti_olustur_yukle()

    def baglanti_olustur_yukle(self):
        ...
        cursor.execute(sorgu_yukle, (self.string_db,))  # eğer karakter sayısı 1den fazlaysa boyut bildirilmeli
                                                         # yani (str,) gibi tuple veri tipinde
        connection.commit()

     #7.şık (yani çıkış) düzenlemeler yapılacak v3
    def baglanti_kes(self):
        self.connection.close()


    # düzenlemeler yapılacak v3
